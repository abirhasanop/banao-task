...
const Login = () => {
    ...
    return (
        <div className=''>
            <div className="flex items-center flex-row-reverse w-full mx-auto overflow-hidden rounded-lg dark:bg-gray-800 lg:max-w-4xl">

                <img className='w-1/2' src={SignImage} alt="" />

                <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                    <div className="flex justify-center mx-auto">
                        <img className="w-auto h-7 sm:h-8" src={Logo} alt="Banner" />
                    </div>
                    ...
                    <a onClick={handleGoogleSignIn} href className="cursor-pointer flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mt-4">
                            <div className="flex justify-between">
                                ...
                                <a href="#_" className="text-xs text-gray-500 dark:text-gray-300 hover:underline">Forget Password?</a>
                            </div>
