            ...
            <div className="max-w-2xl overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div className="p-6">
                    <div>
                        ...
                        <a href="#_" className="block mt-2 text-xl font-semibold text-gray-800 transition-colors duration-300 transform dark:text-white hover:text-gray-600 hover:underline" tabIndex="0" >I Built A Successful Blog In One Year</a>
                    ...
                    <div className="mt-4">
                        <div className="flex items-center">
                            <div className="flex items-center">
                                ...
                                <a href="#_" className="mx-2 font-semibold text-gray-700 dark:text-gray-200" tabIndex="0">Jone Doe</a>
                            </div>
